    ...
    return (
        ...
        <div className="inforSearch">
            <form className="form-signin2">
                        ...
                        <div className="mb-3 row text-xl-center">
                            <label htmlFor="inputDay" className="col-sm-2 col-form-label">CCCD</label>
                            <div className="col-sm-10">
                                <input
                                    type="text"
                                    className="form-controlSearchTicket"
                        ...
                        <div className="mb-3 row text-xl-center">
                            <label htmlFor="inputTicketCode" className="col-sm-2 col-form-label">Mã chuyến bay</label>
                            <div className="col-sm-10">
                                <input
                                    type="text"
                                    className="form-controlSearchTicket"
                                    id="inputTicketCode"
                                    value={searchInfo.maChuyenBay}
                                    onChange={(e) => setSearchInfo({ ...searchInfo, maChuyenBay: e.target.value })}
                                />
                            </div>
                        </div>
